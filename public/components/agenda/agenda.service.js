siteApp.service('agendaService', function($http) {
    var service = this;
    ...
    service.view = function (userId) {
    	return $http({
            method: 'GET', 
            url: 'http://localhost:3000/appointments/?userId=' + userId
        }).then(function success(response) { 
            return response.data; 
		}, function error(response) {
            return response.status; 
    ...
    service.viewTeamAgenda = function () {
    	return $http({
            method: 'GET', 
            url: 'http://localhost:3000/appointments'
        }).then(function success(response) { 
